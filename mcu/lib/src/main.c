...
// 10/20/2025
//
// Below is the Arduino code for the phase control modulation and is in the process
// of being configured to the STM32L432KC MCU
...
// NOTE: Most of the code is extra calling on GPIO pins and other functions that
// are placed in the supporting libraries such as SPI.h/c, GPIO.h/c and so on.
